"""DocMD MCP Server — exposes document conversion tools via MCP protocol."""
...
async def list_tools() -> list[Tool]:
    return [
        Tool(
            ...
            description="Submit a Markdown document to DocMD. Returns the document record with classification suggestions.",
            inputSchema={
                "type": "object",
                "properties": {
                    ...
                    "api_key": {"type": "string", "description": "DocMD API key"},
                },
